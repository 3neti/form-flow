...
it('renders disbursement details as large mobile-safe destination controls', function (): void {
    ...
    expect($stub)
        ...
        ->toContain('placeholder:text-sm placeholder:font-normal')
        ...
        ->toContain('function fieldStateClass')
        ->toContain('border-amber-300 bg-amber-50/40')
        ->toContain('function copyClaimMobileToAccount')
        ->toContain('Use claim mobile')
        ->toContain('Using claim mobile')
        ->toContain('function clearAccountNumber')
        ->toContain('Clear')
        ->toContain('Account number help')
        ->toContain('payoutDestinationRouteSegments')
        ->toContain('payoutDestinationRouteIcons')
        ->not->toContain('payoutRouteSegments({')
        ->not->toContain('payoutRouteIcons({')
        ->not->toContain('payoutRouteSummary')
        ->toContain('function shouldShowPayoutRouteSegmentText')
        ->toContain('overflow-hidden whitespace-nowrap')
        ->toContain('min-w-0 truncate')
        ->toContain('size-class="h-5 w-5"')
        ->toContain('sr-only')
        ->toContain('Send to')
